...
const Ambassdorcreate = ({history}) => {
  ...
  const handleSubmit = (e) => {
    ...
    if(!firstName || !description || !image || !linkToTheAmbassador || !followers || !whyTecton ){
        ...
        axios.post(`${process.env.REACT_APP_PROXY_URL}/api/carousel/create-carousel`,{
            firstName,
            description,
            image,
            linkToTheAmbassador,
        ...
        <div>
            <div className="productEditPage">
                ...
                <FormContainer style={{ marginTop: "-2em" }}>
                    <h1 className="productEditPage_heading"> Create Ambassdor's Testimonial</h1>
                    <Form onSubmit={handleSubmit}>
                        <Form.Group controlId="name">
                            <FloatingLabel
                                controlId="nameinput"
                                label="Ambassador's Name"
                                className="mb-3"
                            >
                                <Form.Control
                                    size="lg"
                      ...
                      onChange={(e) => setFirstName(e.target.value)}
                        ...
                        <Form.Group controlId="shortdesc">
                            <FloatingLabel
                                controlId="shortdesc"
                                label="Ambassador's Short Description"
                                className="mb-3"
                            >
                                <Form.Control
                                    size="lg"
...
export default Ambassdorcreate;
