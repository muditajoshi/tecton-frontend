        ...
        <div class="Act">
          <div class="row">
              ...
              <div class="contact-info">
                <div id="dep1">
                  <ul class="menu-drop">
                    ...
                    <li>
                      <a style={{ color: "orange" }} href="/refer">
                        REFER A FRIEND
                      </a>
                    </li>
                    <li>
            ...
            <div class="col-sm-8 ">
              <div class="row">
                <div class="m-acc">
                  <h3 class="samk">Refer A Friend</h3>
                  <div style={{ fontSize: "19px", paddingLeft: "30px" }}>
                    Coming Soon
                  </div>

                  {/* <div ><p class="ad-info">Tell your friends about Tecton® and recieve credits on your account when they purchase</p></div>
                <div class="contact-for">
                  <div class="fs-group">
                    <label class="control-label col-sm-2" for="fname">Your Referral link</label>
                    <div class="col-sm-10">
                    <div class="col-cnfm-ref">
									<input type="text" class="form-control-ship-exp-cnfm " placeholder="Add a promo code" id="fname" name="fname" />
									<input class="product-btn-default-cnfm" type="submit" value="COPY" ></input>
								</div>
                    </div>
                  </div>
                </div> */}
