...
const  WholesaleInterest = () => {
  ...
  const openKlaviyoForm = () => {
    ...
    window._klOnsite.push(['openForm', 'U8BaBh']); 
  };
...
<div class="klaviyo-form-U8BaBh"></div>
...
export default  WholesaleInterest;
