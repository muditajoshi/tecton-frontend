...
import "../css/TermsOfServicePg.css";

function TermsOfService() {
  return (
    <div class="container">
      <div className="termandcondition" style={{fontFamily:"aktiv",fontSize:"1rem"}}>
        <h1 className="header1">
          <b>Terms and Conditions</b>
        </h1>
        <h4>
          <b>Agreement between User and www.tectonlife.com</b>
        </h4>
        <p>
          Welcome to www.tectonlife.com. The www.tectonlife.com website (the
          "Site") is comprised of various web pages operated by Tecton Group
          ("Tecton"). www.tectonlife.com is offered to you conditioned on your
          acceptance without modification of the terms, conditions, and notices
          contained herein (the "Terms"). Your use of www.tectonlife.com
          constitutes your agreement to all such Terms. Please read these terms
          carefully and keep a copy of them for your reference.
          <br />
          <br />
          www.tectonlife.com is an E-Commerce Site.
          <br />
          <br />
          Tecton is a Ketone Hydration and focused performance beverage helping
          people harvest their true potential. The website will sell and promote
          Tecton and other related products. In addition, the website will serve
          as a platform to engage with consumers and participate in their
        ...
        <p>
          Your use of www.tectonlife.com is subject to Tecton's Privacy Policy.
        ...
        <p>
          Visiting www.tectonlife.com or sending emails to Tecton constitutes
        ...
        <p>
          ...
          entity. You acknowledge that Tecton is not responsible for third party
          access to your account that results from theft or misappropriation of
          your account. Tecton and its associates reserve the right to refuse or
        ...
        <p>
          Tecton does not knowingly collect, either online or offline, personal
          information from persons under the age of thirteen. If you are under
          18, you may use www.tectonlife.com only with permission of a parent or
          guardian.
        </p>
        ...
        <p>
          www.tectonlife.com may contain links to other websites ("Linked
          Sites"). The Linked Sites are not under the control of Tecton and
          Tecton is not responsible for the contents of any Linked Site,
          including without limitation any link contained in a Linked Site, or
          any changes or updates to a Linked Site. Tecton is providing these
          links to you only as a convenience, and the inclusion of any link does
          not imply endorsement by Tecton of the site or any association with
          its operators.
          <br />
          <br />
          Certain services made available via www.tectonlife.com are delivered
          by third party sites and organizations. By using any product, service
          or functionality originating from the www.tectonlife.com domain, you
          hereby acknowledge and consent that Tecton may share such information
          and data with any third party with whom Tecton has a contractual
          relationship to provide the requested product, service or
          functionality on behalf of www.tectonlife.com users and customers.
        </p>
        ...
        <p>
          ...
          to access and use www.tectonlife.com strictly in accordance with these
          terms of use. As a condition of your use of the Site, you warrant to
          Tecton that you will not use the Site for any purpose that is unlawful
          ...
          used on the Site, is the property of Tecton or its suppliers and
          ...
          Tecton content is not for resale. Your use of the Site does not
          ...
          content without the express written permission of Tecton and the
          ...
          express or implied, to the intellectual property of Tecton or our
        ...
        <p>
          ...
          <br />
          <br />
          Tecton has no obligation to monitor the Communication Services.
          However, Tecton reserves the right to review materials posted to a
          Communication Service and to remove any materials in its sole
          discretion. Tecton reserves the right to terminate your access to any
          or all of the Communication Services at any time without notice for
          any reason whatsoever.
          <br />
          <br />
          Tecton reserves the right at all times to disclose any information as
          ...
          information or materials, in whole or in part, in Tecton's sole
          discretion.
          <br />
          <br />
          ...
          Service. Tecton does not control or endorse the content, messages or
          information found in any Communication Service and, therefore, Tecton
          ...
          Communication Service. Managers and hosts are not authorized Tecton
        ...
        <h4>
          <b>
            Materials Provided to www.tectonlife.com or Posted on Any Tecton Web
            Page
          </b>
        </h4>
        <p>
          Tecton does not claim ownership of the materials you provide to
          www.tectonlife.com (including feedback and suggestions) or post,
          upload, input or submit to any Tecton Site or our associated services
          (collectively "Submissions"). However, by posting, uploading,
          inputting, providing or submitting your Submission you are granting
          Tecton, our affiliated companies and necessary sublicensees permission
          ...
          Submission, as provided herein. Tecton is under no obligation to post
          or use any Submission you may provide and may remove any Submission at
          any time in Tecton's sole discretion.
          <br />
          <br />
        ...
        <p>
          You will be able to connect your Tecton account to third party
          accounts. By connecting your Tecton account to your third party
        ...
        <p>
          The Service is controlled, operated and administered by Tecton from
          ...
          laws. You agree that you will not use the Tecton Content accessed
          through www.tectonlife.com in any country or in any manner prohibited
        ...
        <p>
          You agree to indemnify, defend and hold harmless Tecton, its officers,
          ...
          Tecton reserves the right, at its own cost, to assume the exclusive
          defense and control of any matter otherwise subject to indemnification
          by you, in which event you will fully cooperate with Tecton in
        ...
        <p>
          ...
          Further, unless both you and Tecton agree otherwise, the arbitrator
        ...
        <p>
          ...
          TECTON GROUP AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES
          IN THE SITE AT ANY TIME.
          <br />
          <br />
          TECTON GROUP AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
          ...
          CONDITION OF ANY KIND. TECTON GROUP AND/OR ITS SUPPLIERS HEREBY
          ...
          TECTON GROUP AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT, INDIRECT,
          ...
          STRICT LIABILITY OR OTHERWISE, EVEN IF TECTON GROUP OR ANY OF ITS
        ...
        <p>
          Tecton reserves the right, in its sole discretion, to terminate your
          ...
          agreement is governed by the laws of the State of Louisiana and you
          hereby consent to the exclusive jurisdiction and venue of courts in
          Louisiana in all disputes arising out of or relating to the use of the
          Site. Use of the Site is unauthorized in any jurisdiction that does
          not give effect to all provisions of these Terms, including, without
          limitation, this section.
          <br />
          <br />
          You agree that no joint venture, partnership, employment, or agency
          relationship exists between you and Tecton as a result of this
          agreement or use of the Site. Tecton's performance of this agreement
          is subject to existing laws and legal process, and nothing contained
          in this agreement is in derogation of Tecton's right to comply with
          ...
          gathered by Tecton with respect to such use. If any part of this
          ...
          entire agreement between the user and Tecton with respect to the Site
          ...
          Tecton with respect to the Site. A printed version of this agreement
        ...
        <p>
          Tecton reserves the right, in its sole discretion, to change the Terms
          under which www.tectonlife.com is offered. The most current version of
          the Terms will supersede all previous versions. Tecton encourages you
        ...
        <p>
          Tecton welcomes your questions or comments regarding the Terms:
          <br />
          <br />
          Tecton Group
          <br />
          370 River Road Alexandria
          <br />
        ...
        <p>
          ...
          <br />
          <br />
          Effective as of August 01, 2022
        </p>
      </div>
    </div>
  );
