...
function Fyr({ location }) {
  ...
  return (
    <div className="Fyr container" style={{fontFamily:"aktiv" ,fontSize:"0.9rem"}}>
      ...
      <form onSubmit={handleEmailSubmit}>
        ...
        <div class="mb-2">
          <label for="exampleInputPassword1" class="form-label">
            <b>No problem! We're here to help.</b>
          </label>
        </div>

        <div class="mb-4  ">
          <label for="exampleInputPassword1" class="form-label">
            Enter your email below and we can send you a password reset email.{" "}
          </label>
        </div>
