...
import UpdateAddshipping from '../components/updateAddshipping';
import {
          ...
          <div class="all-product">
            ...
            <div class="container">
              <div >
                <div class="row">
                  <div class="m-acc">
                    <h3 class="pro-duct-quick-edit-billing" >Add an Address </h3>
...
<div class="col">
                ...
                {/* {toggle22 && <UpdateAddshipping  close={() => setToggle22(false)} />} */}
                        ...
                        <div className='cancel-button-billing'  > <button style={{ paddingTop: "4px", paddingBottom: "1px", paddingLeft: "14px", paddingRight: "14px", backgroundColor: "white", fontSize: "15px", borderRadius: "20px", border: "1px solid",color:"black" }} onClick={() => close()} type="button" >CANCEL</button>
                        </div>
