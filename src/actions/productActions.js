	...
	async (dispatch) => {
		try {
			...
			const { data } = await axios.get(
				`${process.env.REACT_APP_PROXY_URL}/api/products?keyword=${keyword}&pageNumber=${pageNumber}&pageSize=${pageSize}`
			);
...
export const deleteProduct = (id) => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.delete(`${process.env.REACT_APP_PROXY_URL}/api/products/${id}`, config);
...
export const createProduct = () => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.post(`${process.env.REACT_APP_PROXY_URL}/api/products/`, {}, config);
...
export const updateProduct = (product) => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.put(
			`${process.env.REACT_APP_PROXY_URL}/api/products/${product._id}`,
			product,
			config
		);
...
export const createProductReview =
	(productID, review) => async (dispatch, getState) => {
		try {
			...
			await axios.post(
				`${process.env.REACT_APP_PROXY_URL}/api/products/${productID}/reviews`,
				review,
				config
			);
...
export const getTopRatedProducts = () => async (dispatch) => {
	try {
		...
		const { data } = await axios.get(`${process.env.REACT_APP_PROXY_URL}/api/products/top`);
